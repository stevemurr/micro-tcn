...
static DESCRIPTOR: clap_plugin_descriptor = clap_plugin_descriptor {
    ...
    id: b"com.microtcn.tcn-rat\0".as_ptr() as *const c_char,
    name: b"micro-TCN RAT\0".as_ptr() as *const c_char,
    ...
    description: b"Neural ProCo RAT2 distortion.\0".as_ptr() as *const c_char,

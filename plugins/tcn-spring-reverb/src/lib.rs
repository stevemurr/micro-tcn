...
static FEATURES: FeaturesPtr = FeaturesPtr([
    ...
    b"reverb\0".as_ptr() as *const c_char,
    std::ptr::null(),
]);

static DESCRIPTOR: clap_plugin_descriptor = clap_plugin_descriptor {
    clap_version: CLAP_VERSION,
    id: b"com.microtcn.tcn-spring-reverb\0".as_ptr() as *const c_char,
    name: b"micro-TCN Spring Reverb\0".as_ptr() as *const c_char,
    ...
    description: b"Neural Orange CR-60 spring reverb.\0".as_ptr() as *const c_char,

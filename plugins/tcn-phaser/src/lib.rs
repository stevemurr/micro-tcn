...
static FEATURES: FeaturesPtr = FeaturesPtr([
    ...
    b"phaser\0".as_ptr() as *const c_char,
    std::ptr::null(),
]);

static DESCRIPTOR: clap_plugin_descriptor = clap_plugin_descriptor {
    clap_version: CLAP_VERSION,
    id: b"com.microtcn.tcn-phaser\0".as_ptr() as *const c_char,
    name: b"micro-TCN Phaser\0".as_ptr() as *const c_char,
    ...
    description: b"Neural MXR Phase 45 phaser.\0".as_ptr() as *const c_char,

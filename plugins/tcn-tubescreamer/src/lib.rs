...
static DESCRIPTOR: clap_plugin_descriptor = clap_plugin_descriptor {
    ...
    id: b"com.microtcn.tcn-tubescreamer\0".as_ptr() as *const c_char,
    name: b"micro-TCN TubeScreamer\0".as_ptr() as *const c_char,
    ...
    description: b"Neural tube-screamer distortion.\0".as_ptr() as *const c_char,

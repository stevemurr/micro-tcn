...
static FEATURES: FeaturesPtr = FeaturesPtr([
    ...
    b"flanger\0".as_ptr() as *const c_char,
    std::ptr::null(),
]);

static DESCRIPTOR: clap_plugin_descriptor = clap_plugin_descriptor {
    clap_version: CLAP_VERSION,
    id: b"com.microtcn.tcn-flanger\0".as_ptr() as *const c_char,
    name: b"micro-TCN Flanger\0".as_ptr() as *const c_char,
    ...
    description: b"Neural Mooer E-Lady flanger.\0".as_ptr() as *const c_char,

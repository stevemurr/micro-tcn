...
static FEATURES: FeaturesPtr = FeaturesPtr([
    ...
    b"distortion\0".as_ptr() as *const c_char,
    std::ptr::null(),
]);

static DESCRIPTOR: clap_plugin_descriptor = clap_plugin_descriptor {
    clap_version: CLAP_VERSION,
    id: b"com.microtcn.tcn-bluesdriver\0".as_ptr() as *const c_char,
    name: b"micro-TCN Blues Driver\0".as_ptr() as *const c_char,
    ...
    description: b"Neural Boss BD-2 Blues Driver overdrive.\0".as_ptr() as *const c_char,
